...
Característica: Validar el funcionamiento de los formularios de ParaBank
  ...
  Esquema del escenario: Registro exitoso de un nuevo usuario
    ...
    Ejemplos:
      ...
      | chrome    | Juan      | Flores   | Calle 123 | Madrid | Madrid | 28001   | 555-0101 | 123-45-6789 | testingEncora4 | testing1997 |
      | edge      | Juan      | Flores   | Calle 123 | Madrid | Madrid | 28001   | 555-0101 | 123-45-6789 | testingEncora5 | testing1997 |